...
| 8 Dashboard NiceGUI | audit user lulus; websocket ≥10 mnt; cold start <8 s | ⏳ **butuh user** | UI hidup; tangkapan layar `docs/screenshots/`; temuan-1 (sparkline legacy datar) diperbaiki di kode 25 Agu 18:05, bukti `desktop_incident_sparkline_fix.png`, **belum deploy** |
